(() => {
  ...
  const english = {
    ...
    heroTitle: 'Vision systems should know<br />when not to be confident.',
    heroSummary: 'I am Yang Li, a computer vision algorithm engineer working on OOD Detection, Failure Prediction, and production systems for classification, Re-ID, detection, and segmentation.',
    ...
    experienceTitle: 'From research validation to production', jobDate: 'Jul 2023 - Present', jobCompany: 'Hefei Intellindust Information Technology Co., Ltd.', jobTitle: 'Computer Vision Algorithm Engineer',
